  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/login', {
        ...
        credentials: 'include',
        body: JSON.stringify({ usuario: username, password, modulo: 'servicios' })
      });
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-ccb-blue focus:ring-ccb-blue border-gray-300 cursor-pointer rounded-sm"
                />
                <label
                  htmlFor="remember-me"
              ...
              <div className="text-sm">
                <a
                  href="#"
                  className="font-medium text-gray-600 hover:text-ccb-blue transition-colors"
                >
